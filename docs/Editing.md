...
<img src="img/getting-started/edit-button.png" alt="edit-button" width="45%" /> &nbsp; <img src="img/editing/initial-edit-screen-1024x768.png" alt="initial-edit-screen-1024x768.png" width="45%" />
...
<img src="img/editing/add-item-modal-1024x768.png" alt="Home Information Add Item Dialog" width="55%"> 
...
<img src="img/editing/first-item-center-1024x768.png" alt="Home Information Initial Item" width="45%">  <img src="img/editing/first-item-moved-scaled-1024x768.png" alt="Home Information Moved Item" width="45%"> 
...
<img src="img/editing/edit-reference-help-1024x768.png" alt="Editing Reference Help" width="55%">
...
<img src="img/editing/add-area-item-modal-1024x768.png" alt="Home Information Adding Pool" width="45%"> &nbsp; <img src="img/editing/first-area-center-1024x768.png" alt="Home Information Initial Pool Item" width="45%">
...
<img src="img/editing/first-area-edit-start-1024x768.png" alt="Home Information Pool Selected" width="45%"> &nbsp; <img src="img/editing/first-area-edit-moved-1024x768.png" alt="Home Information Pool Moved" width="45%">
...
<img src="img/editing/first-area-edit-shaped-1024x768.png" alt="Home Information Pool Reshaped" width="45%"> &nbsp; <img src="img/editing/first-area-shaped-done-1024x768.png" alt="Home Information Pool Done" width="45%">
...
<img src="img/editing/add-line-item-modal-1024x768.png" alt="Home Information Adding Electric" width="45%"> &nbsp; <img src="img/editing/first-line-center-1024x768.png" alt="Home Information Initial Electric Item" width="45%">
...
<img src="img/editing/first-line-edit-start-1024x768.png" alt="Home Information Electric Selected" width="32%"> &nbsp; <img src="img/editing/first-line-edit-moved-1024x768.png" alt="Home Information Electric Moved" width="32%"> &nbsp; <img src="img/editing/first-line-edit-done-1024x768.png" alt="Home Information Electric Done" width="32%">
...
<img src="img/editing/new-collection-button-1024x768.png" alt="Home Information Adding Collection" width="45%"> 
<img src="img/editing/add-collection-modal-1024x768.png" alt="Home Information Adding Collection" width="45%">
...
<img src="img/editing/collection-edit-view-empty-1024x768.png" alt="Home Information Empty Collection" width="55%"> 
...
<img src="img/editing/collection-edit-list-view-1024x768.png" alt="Home Information Collection List" width="45%">  <img src="img/editing/collection-edit-grid-view-1024x768.png" alt="Home Information Collection Grid" width="45%"> 
...
By default, you will see there is just one view created called "All".  In editing mode you will also see the "ADD VIEW" button on the top left to create new views.  Let's suppose we want to have a view that just focuses on the items in the Kitchen area. Click the "ADD VIEW" button, given it a name in the dialog and then you will see a new button and a new, but empty view.
 ...
 <img src="img/editing/new-location-view-button-1024x768.png" alt="Home Information New Space View" width="45%"> &nbsp; <img src="img/editing/add-location-view-modal-1024x768.png" alt="Home Information New Space View" width="45%">
...
<img src="img/editing/new-location-view-populated-1024x768.png" alt="Home Information Initial Space View" width="55%">
...
<img src="img/editing/new-location-view-zoomed-1024x768.png" alt="Home Information Zoomed Space View" width="55%">
...
<img src="img/editing/new-location-view-edit-zoomed-1024x768.png" alt="Home Information Space View Edit" width="55%">
...
<img src="img/editing/new-location-drop-down-1024x768.png" alt="Home Information New Space" width="32%"> &nbsp; <img src="img/editing/add-location-modal-1024x768.png" alt="Home Information Space Dialog" width="32%"> &nbsp; <img src="img/editing/new-location-added-drop-down-1024x768.png" alt="Home Information Space Menu" width="32%">
...
<img src="img/screenshots/template-selector-1024x768.png" alt="Background selection" width="55%">
...
<img src="img/editing/new-location-alt-svg-1024x768.png" alt="Home Information Attic Space" width="55%">
